...
public class ClickActionTask extends UniversalRunnable {
    ...
    private static final ConcurrentHashMap<String, Boolean> IN_ACTION = new ConcurrentHashMap<>();
    ...
    public void run() {
        ...
        final String inActionKey = this.uuid + ":" + this.actionType.name() + ":" + this.exec;
        if (IN_ACTION.putIfAbsent(inActionKey, Boolean.TRUE) != null) {
            return;
        }
